...
- Use the top-level edges array only for 0-2 important cross-links that are not already captured by attachToTitle.
...
EDGE LABELS
- Edge labels MUST be exactly one categorical tag from this set: CAUSES, ENABLES, PART_OF, DEPENDS_ON, BLOCKS, SUPPORTS, CONTRADICTS, ANSWERS, LEADS_TO, TESTS, EXAMPLE_OF, RISK_OF, ALTERNATIVE_TO, REFINES.
